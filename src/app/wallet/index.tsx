    ...
    <View className="flex-1 p-2 bg-gray-50">
      ...
      <View className="flex-row justify-between items-center px-4 pt-12 pb-4">
        <View className="flex-row items-center">
          ...
          <Text className="text-lg font-semibold">Hello James</Text>
        </View>
        <TouchableOpacity className="bg-[#F1F2EE] p-2 rounded-full">
      ...
      <ScrollView className="flex-1">
        ...
        >
          <View className="mx-4 my-2 border border-[#D9D9D9] bg-white rounded-3xl p-4">
            <View className="flex-row justify-between items-center">
              <View>
                <Text className="text-4xl font-bold">{show ? "₦" + formatBalance(balance) : '******'}</Text>
                <Text className="text-gray-400 mt-2">Nigeria Naira</Text>
              </View>
        ...
        <View className="flex-row justify-between mx-4 my-2">
          ...
          >
            <View className="">
              <TouchableOpacity
                className="flex-row items-center justify-center bg-white border border-[#0CB9DE] rounded-full py-3 px-6">
        ...
        <View className="mx-4 my-2">
          ...
          <Pressable onPress={() => refRBSheet2.current.open()}>
            <View className="bg-[#E8F5E9] rounded-xl p-4 mb-3 flex-row">
              ...
              <View className="flex-1">
                <Text className="font-bold text-base">Protect Your Account from Threats</Text>
          ...
          <Pressable onPress={() => refRBSheet2.current.open()}>
            <View className="bg-[#FFEBEE] rounded-xl p-4 mb-3 flex-row">
              ...
              <View className="flex-1">
                <Text className="font-bold text-base">Get the Most Out of Your App</Text>
                <Text className="text-gray-700 text-sm mt-1">
        ...
        {/* Transactions */}
        <View className="mx-4 my-2">
          <Text className="font-bold text-lg mb-2">Transactions</Text>
          {transactions.length >= 1 ? transactions.map((transaction: any, index: any) => <View key={index} className="flex-row items-center mb-4">
            ...
            <View className="flex-1">
              <Text className="font-semibold">{transaction.receiver}</Text>
              <Text className="text-gray-500 text-xs">{formatDate(transaction.date)}</Text>
            </View>
            <Text className="font-bold text-red-500">-{formatBalance(transaction.amount)}</Text>
          </View>
          ) : <Text className="">No available transactions</Text>}
        ...
        >
          <View className="p-6">
            <View className="flex-row justify-between mb-3">
              <Text className="font-bold text-xl">Cybersecurity Tips for Safe Banking</Text>
            ...
            <View className="flex-row mb-3">
              ...
              <Text className="text-lg">Enable Two-Factor Authentication (2FA) to add an extra layer of security to your account.</Text>
            </View>
            <View className="flex-row mb-3">
              <Image className="mr-3" source={require("../../../assets/images/carat.png")} />
              <Text className="text-lg">Never Share Your OTP or Password. No bank representative will ever ask for it.</Text>
            </View>
            <View className="flex-row mb-3">
              <Image className="mr-3" source={require("../../../assets/images/carat.png")} />
              <Text className="text-lg">Use Strong Passwords.  Avoid using the same password for multiple apps.</Text>
            </View>
            <View className="flex-row mb-3">
              <Image className="mr-3" source={require("../../../assets/images/carat.png")} />
              <Text className="text-lg">Be Wary of Phishing Links. Only click links from official sources.</Text>
            </View>
            <View className="flex-row mb-3">
              <Image className="mr-3" source={require("../../../assets/images/carat.png")} />
              <Text className="text-lg">Keep Your App Updated. Updates fix known vulnerabilities.</Text>
            </View>
          </View>
        </RBSheet>
        <RBSheet
        ...
        >
          <View className="p-6">
            <View className="flex-row justify-between mb-3">
              <Text className="font-bold text-xl">Your Data, Your Rights</Text>
            ...
            <View className="flex-row mb-3">
              <Image className="mr-3" source={require("../../../assets/images/carat.png")} />
              <Text className="text-lg">We only collect what’s necessary to provide secure, efficient banking services.</Text>
            </View>
            <View className="flex-row mb-3">
              <Image className="mr-3" source={require("../../../assets/images/carat.png")} />
              <Text className="text-lg">Your data is encrypted both in transit and at rest.</Text>
            </View>
            <View className="flex-row mb-3">
              <Image className="mr-3" source={require("../../../assets/images/carat.png")} />
              <Text className="text-lg">We never sell your data to third parties.</Text>
            </View>
            <View className="flex-row mb-3">
              <Image className="mr-3" source={require("../../../assets/images/carat.png")} />
              <Text className="text-lg">You can review, download, or delete your personal data anytime via your profile settings.</Text>
            </View>
            <View className="flex-row mb-3">
              <Image className="mr-3" source={require("../../../assets/images/carat.png")} />
              <Text className="text-lg">We use anonymized data for improving user experience and security.</Text>
            </View>
          </View>
        </RBSheet>
      </ScrollView>
